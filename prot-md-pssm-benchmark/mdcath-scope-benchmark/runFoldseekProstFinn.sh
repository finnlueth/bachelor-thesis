...
OUT_DIR=./out/foldseek_3Di_prost_benchmark
...
if [ "$RUN_FOLDSEEK" = true ]; then
    ${FOLDSEEK} createdb ${SEQUENCE_FASTA} ${ALIGN_DIR_TMP}/queryDB --prostt5-model ../scope-benchmark/data/prostt5/prostt5_out/prostt5-f16.gguf --gpu 1
