...
SEQUENCE_FASTA_3Di_argmax=./data/scope40_sequences_3Di_argmax${DATASET_TYPE}.fasta
...
DB_SEQUENCE_ARGMAX=${OUT_DIR}/alignResults/db_sequence_argmax
...
# python generate_foldseek_db_new.py ${SEQUENCE_FASTA_AA} ${SEQUENCE_FASTA_3Di_argmax} ${DB_SEQUENCE_ARGMAX}/${DB_NAME_FOLDSEEK} ${OUT_DIR}
# python generate_foldseek_db_new.py ${SEQUENCE_FASTA_AA} ${SEQUENCE_FASTA_3Di} ${DB_SEQUENCE}/${DB_NAME_FOLDSEEK} ${OUT_DIR}

# ${FOLDSEEK} search ${DB_SEQUENCE_ARGMAX}/${DB_NAME_FOLDSEEK} ${DB_SEQUENCE}/${DB_NAME_FOLDSEEK} ${ALIGN_DIR_ALN} ${ALIGN_DIR_TMP} --threads 48 -s 9.5 --max-seqs 2000 -e 10

# ${FOLDSEEK} convertalis ${DB_SEQUENCE_ARGMAX}/${DB_NAME_FOLDSEEK} ${DB_SEQUENCE}/${DB_NAME_FOLDSEEK} ${ALIGN_DIR_ALN} ${ALIGN_DIR_RAW}/foldseekaln
