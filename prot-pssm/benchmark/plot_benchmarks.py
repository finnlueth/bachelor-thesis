...
def plot_scope_benchmarks(file_paths: dict[str, str]):
    ...
    colors = ['black', 'blue', 'red', 'orange', 'green', 'purple', 'gray', 'olive', 'cyan', 'magenta', 'lime', 'teal', 'navy', 'maroon', 'gold', 'silver', 'indigo', 'turquoise', 'coral', 'khaki', 'lime', 'teal', 'navy', 'maroon', 'gold', 'silver', 'indigo', 'turquoise', 'coral', 'khaki']
    ...
    plt.legend(title="Method", loc="center", ncol=3, bbox_to_anchor=(-0.75, -0.3))
